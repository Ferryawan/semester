...
public class Customer {
    ...
    public void hello(){
        while (menu){
            ...
            if (pilih == 1){
                System.out.println("___________LOGIN MENU_______________");
                loginCheck(null, null);

            }
            if (pilih == 2){
                System.out.println("__________REGISTER MENU_____________");
    ...
    public void onlineShop(){
        while (menu){
            System.out.println("|_____________Selamat Datang di TOKOPEDIA______________|");
            System.out.println("|1.Mulai Belanja                                       |");
            System.out.println("|2.Top Up SCash                                        |");
            System.out.println("|3.Informasi Akun                                      |");
            System.out.println("|00.Kembali Ke Menu Login                              |");
            int pilih = why.nextInt();
